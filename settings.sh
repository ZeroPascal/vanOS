...
#Alert Volume
defaults write "Apple Global Domain" "com.apple.sound.beep.volume" '0'

#Remove Sound Icon from Menu Bar
defaults delete "com.apple.systemuiserver" "NSStatusItem Visible com.apple.menuextra.volume"

#Keyboard Flag
defaults write "com.apple.TextInputMenu" '{visible=0;}'

#Energy
defaults write "com.apple.systempreferences" "com.apple.preferences.energysaver" '{hasBeenWarnedAboutEnergyUsage=YES;}'

#Screen Mirror Icon
defaults write "com.apple.airplay" "showInMenuBarIfPresent" '0'

#Wifi Icon 
defaults delete "com.apple.systemuiserver" "NSStatusItem Visible com.apple.menuextra.airport"
defaults write "com.apple.systemuiserver" "menuExtras" '("/System/Library/CoreServices/Menu Extras/Clock.menu",)'

#Bluetooth Menu Bar
defaults delete "com.apple.systemuiserver" "NSStatusItem Visible com.apple.menuextra.bluetooth"
...
#HD to Upper Right
defaults write "com.apple.finder" "FXDesktopVolumePositions" '<dict><key>Macintosh HD_0x1.36d734c90e88p+29</key><dict><key>AnchorRelativeTo</key><string>1</string><key>ScreenID</key><string>0</string><key>xRelative</key><string>-65</string><key>yRelative</key><string>63</string></dict></dict>'
